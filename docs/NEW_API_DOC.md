...
- Description: Get detailed salary information about a specific teacher by their ID.
...
#### GET /admin/teacher-salary/:teacherId/history

- Description: Get salary payment history for a specific teacher by their ID.
- Request:
  - Parameters:
    - teacherId (string, required) - The ID of the teacher to retrieve salary history for.
- Response:
...
- Process: create a new salary payment entry in the payments table, and salaryPayment for the teacher, and update the last paid date in the teachers table.
